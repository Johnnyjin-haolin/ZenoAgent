...
public class AgentConversationController {
    ...
    public ResponseEntity<Result<Map<String, Object>>> getConversations(
        ...
        com.aiagent.api.dto.Page<ConversationInfo> page =
    ...
    public ResponseEntity<Result<List<com.aiagent.api.dto.MessageDTO>>> getConversationMessages(
            @PathVariable("id") String conversationId,
            @RequestParam(required = false, defaultValue = "50") Integer limit) {
        List<com.aiagent.api.dto.MessageDTO> messages =
