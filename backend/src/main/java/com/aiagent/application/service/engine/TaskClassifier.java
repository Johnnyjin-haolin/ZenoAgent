...
public class TaskClassifier {
     ...
     * @return 任务类型
     */
    public TaskType classify(String userInput, com.aiagent.application.model.AgentContext context) {
     ...
     * 使用LLM进行任务分类
     */
    private TaskType classifyWithLLM(String userInput, com.aiagent.application.model.AgentContext context) {
        // TODO: 实现完整的LLM分类
        // 当前简化实现：使用默认分类逻辑
