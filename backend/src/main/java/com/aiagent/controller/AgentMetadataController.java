...
public class AgentMetadataController {
    ...
    public ResponseEntity<Result<List<com.aiagent.vo.McpGroupInfo>>> getMcpGroups() {
    ...
    public ResponseEntity<Result<com.aiagent.vo.McpGroupInfo>> getMcpGroup(@PathVariable String groupId) {
    ...
    public ResponseEntity<Result<List<com.aiagent.vo.McpToolInfo>>> getMcpTools(@RequestParam(required = false) List<String> groups) {
